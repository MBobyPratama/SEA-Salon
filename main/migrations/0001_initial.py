# Generated by Django 5.0.6 on 2024-07-01 18:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('haircuts', 'Haircuts and Styling'), ('manicure', 'Manicure and Pedicure'), ('facial', 'Facial Treatments')], max_length=100)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='main.branch')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
